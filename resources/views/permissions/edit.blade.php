    ...
    <div class="container">
        <div class="row">
            <div class="col-6 offset-3 text-center pt-5">
                <h1 class="display-one mt-5">Edit Permissions</h1>
                <div class="text-left"><a href="/permissions" class="btn btn-outline-primary">Permissions List</a></div>

                <form id="edit-frm" method="POST"
                    action="{{ route('permissions.update', ['permission' => $permission->id]) }}" class="border p-3 mt-2">
                    ...
                    <div class="control-group col-12 text-left">
                        ...
                        <div>
                            <textarea rows="4" cols="50" type="text" id="description" class="form-control mb-4" name="description"
